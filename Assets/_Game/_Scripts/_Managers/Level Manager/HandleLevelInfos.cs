...
public class HandleLevelInfos : MonoBehaviour, IHandleLevelInfo
{
    ...
    public LevelInfo GetLevelInfo(int levelIndex)
    {
        ...
        else
        {
            ...
            // Get the count of total levels available.
            int levelCount = LevelInfoAsset.levelInfos.Count;

            // Return reminder of dividing current level by total level count.
            // This will help us loop the levels when we reach the final level available.
            return LevelInfoAsset.levelInfos[infoIndex % levelCount];
        }
    }
    #endregion
}